...
const swap_model_1 = __importDefault(require("./swap.model"));
const repository = __importStar(require("../../services/repository.service"));
const addSwap = (body) => __awaiter(void 0, void 0, void 0, function* () {
    const { transactionHash, blockHash, blockNumber, address, returnValues } = body;
    const { from, isForeignSwap, receivedAmount, sentAmount, commission, timestamp, startValue, endValue, } = returnValues.swapStructObj;
    const swapRecord = new swap_model_1.default({
        transactionHash,
        blockHash,
        blockNumber,
        contract: address,
    ...
    yield repository.save(swapRecord);
});
